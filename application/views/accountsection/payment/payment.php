                    ...
                    <form role="form" data-toggle="validator" method="post" action="<?= site_url()?>accountsection/student_data">
                        ...
                        <div class="row margin_left">
                            ...
                            <div class="form-group has-feedback col-md-6">
                                ...
                                <input type="text" name="find_registration"  style="color: white" class="form-control" placeholder="Enter Registration Number" required/>
                                  <span class="help-block with-errors" style="margin-left:10px; "></span>
                            </div>
                             <div class=" col-sm-4">
                                 <a href="<?= site_url() . 'accountsection/student_data'?>"style="position: relative;top: 25px;" type="submit" name="submit" class="btn btn-primary col-sm-3">Submit</a>
                            </div>
