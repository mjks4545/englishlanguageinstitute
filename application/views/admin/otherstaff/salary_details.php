        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div  class="panel-heading">Employee details
                     <a href="<?= site_url()?>otherstaff/staff_index" type="button" class="btn btn-primary btn-outline margin col-sm-1 pull-right"><b>Back</b></a>   
                     <a href="<?= site_url()?>otherstaff/salary_payment/<?=$staff[0]->id;?>" type="button" class="btn btn-primary btn-outline margin col-sm-1 pull-right"><b>Pay Salary</b></a>
                </div>
                <div class="panel-body">
                    <table data-toggle="table" data-show-refresh="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                        ...
                        <tr>
                            ...
                            <th  data-sortable="true"><b>Teacher ID</b></th>
                            <th  data-sortable="true"><b>Salary/Month</b></th>
                            <th  data-sortable="true"><b>Paid Salary</b></th>
                        ...
                        <?php  foreach ($result as $array) {?>
                            <tr>
                                <td><?php echo $array->fkstaff_id;?></td>
                                <td><?php echo $array->total_salary;?></td>
                                <td><?php echo $array->payed_salary;?></td>
