    ...
    <div class="row">
        <div class="col-lg-10 margin_left">
            <div class="panel panel-default">
                ...
                <a href="<?= site_url()?>otherstaff/salary_details/<?php echo $array->id; ?>" type="button" class="btn btn-primary btn-outline margin col-sm-1  pull-right"><b>Back</b></a>
                </div>
                <div class="panel-body">
                    
                    <form role="form" method="post" action="<?= site_url()?>otherstaff/add_staff_salary_after_post">
                        <div class="row">
