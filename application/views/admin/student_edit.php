                        ...
                        <div class="row">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea type="text" name="description" style="color: white" class="form-control" placeholder="Write something here..!!"  cols="12" rows="8"><?php echo $result->description ?></textarea>
                                </div>
                            </div>
                            <div class=" col-sm-10">
