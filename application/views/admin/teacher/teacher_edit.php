		...
		<div id="message" role="alert">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" method="post" data-toggle="validator" action="<?= site_url()?>admin/update_teacher_after_post/<?= $result->t_id; ?>/<?= $result->u_id; ?>" id="insert-form-submit" >
                        <div class="row">
                            <div class="form-group has-feedback col-md-6">
                                <label>Teacher Name</label>
                                <input type="text" maxlength="50" minlength="3" name="name" style="color: white" class="form-control" placeholder="Name" value="<?= $result->name?>" required>
				...
				<input type="hidden" id="url" name="url" value="<?=  site_url('admin/teacher_view')?>">
                        ...
                        <div class="row">
                            <div class="form-group has-feedback col-md-6">
                                <label>Contact</label>
                                <input type="text" pattern="(?=.*\d).{7,15}" maxlength="15" minlength="7"  name="number" style="color: white" class="form-control" placeholder="Contact" value="<?= $result->contact?>" required>
                                <span class="help-block with-errors" style="margin-left:10px; "></span>
                            </div>
                             <div class="form-group has-feedback col-md-6">
