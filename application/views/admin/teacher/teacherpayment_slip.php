...
<body>
<a href="<?=site_url()?>admin/teachersalary_details/<?=$t_id?>" class="btn btn-default">back</a><br/>
<div class="col-md-3">
    <div id="page-wrap">
        ...
        <div id="customer">
            ...
            <b>Name:</b> <?php echo str_replace('%20','&nbsp',$name);?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <div style="position: relative;bottom:17px;left: 260px;">Teacher ID:<?=$t_id?></div>
