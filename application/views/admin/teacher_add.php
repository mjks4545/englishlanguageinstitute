        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" method="post" data-toggle="validator" action="<?= site_url()?>admin/create_teacher_after_post">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group has-feedback col-md-6">
                                <label>Contact</label>
                                <input type="text" name="number" pattern="/^\d+$/" maxlength="14" minlength="10" style="color: white" class="form-control" placeholder="Contact" required>
                                <span class="help-block with-errors" style="margin-left:10px; "></span>
                            </div>
                        </div>
                        <div class="row">
