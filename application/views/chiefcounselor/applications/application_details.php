    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <a href="<?= site_url()?>applications/applications_views" type="button" style="position: relative;width: 120px; " class="btn btn-primary btn-outline margin  pull-right"><b>Back</b></a>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3"><b>Date : </b><?= $result->app_created_at?></div>

                    </div>
                    <div class="panel-footer">
                       <a href="<?=site_url()?>applications/status/1/<?=$result->app_id?>/<?=$result->fkuser_id?>" style="margin-left:10px;" class="btn btn-primary pull-right">Confirm</a>
                       <a href="<?=site_url()?>applications/status/2/<?=$result->app_id?>/<?=$result->fkuser_id?>" style="margin-left:10px;" class="btn btn-danger pull-right">Cancel</a>
                    </div>
                </div>
