    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <a href="<?= site_url()?>chiefcounselor/index_details" type="button" style="position: relative;width: 120px; " class="btn btn-primary btn-outline margin  pull-right"><b>Back</b></a>
                </div>
                             ...
                             <tr>
                                 ...
                                 <td>
                                     ...
                                     <?php if($array->status==1){?>
                                         <b class="text-primary">Cofirmed</b>
                                     <?php } ?>
                                     <?php if($array->status==2){?>
                                         <b class="text-primary">Canceled</b>
                                     <?php } ?>
                                 </td>
