    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Application For Leave<a href="<?= site_url()?>chiefcounselor/index_details" type="button" style="position: relative;width: 120px; " class="btn btn-primary btn-outline margin  pull-right"><b>Back</b></a></div>
                <div class="panel-body">

                        <form role="form" data-toggle="validator" method="post" action="<?= site_url()?>applications/create_leave_application_after_post">
                          <input type="hidden" name="application_name" value="leave application">
                            <div class="row">
