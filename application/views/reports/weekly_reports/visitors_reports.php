<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Weekly Reports/ Visitor Reports </li>
        </ol>
    </div><!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Weekly Visitor Reports
                ...
                <div class="panel-body">
                   <legend> <h2 style="text-align:center;">Weekly Visitor Reports</h2></legend>
